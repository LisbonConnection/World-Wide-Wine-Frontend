...
import WWW2025 from "../assets/WWW2025.png";
              ...
              <>
                <div className="flex">
                  <ul className="flex space-x-4 mb-10">
                    <li
                      className="relative group items-center flex"
                    ...
                    >
                      ...
                      {isCollectionOpen && (
                        <div className="absolute left-0 mt-2 w-100 bg-white shadow-lg transform scale-110 transition-all duration-300 ease-out">
                          <ul className="flex">
                            <li>
                              <Link
                                to="/allcollections"
